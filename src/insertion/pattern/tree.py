...
from builtins import str, dict, int
...
class Chunk(object):
    ...
    def __init__(self, sentence, words=None, type=None, role=None, relation=None):
...
class Sentence(object):
    ...
    def append(self, word, lemma=None, type=None, chunk=None, role=None, relation=None, pnp=None, anchor=None, iob=None,
               custom={}):
    ...
    def parse_token(self, token, tags=None):
        ...
        """
        if tags is None:
            tags = [WORD, POS, CHUNK, PNP, REL, ANCHOR, LEMMA]
        p = {WORD: "",
             POS: None,
             IOB: None,
             CHUNK: None,
...
def _parse_tokens(chunk, format=None):
...
def graphviz_dot(sentence, font="Arial", colors=None):
