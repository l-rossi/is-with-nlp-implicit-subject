...
from features.phrase_extraction.sentence_analysing.phrase import Predicate, Phrase, PhraseObject
from features.phrase_extraction.sentence_analysing.util import get_main_verbs_of_sent, get_nominal_subjects_of_verbs, \
